...
from .views import (home, RegisterUser, login_page, logout_link, UserDetail, UserUpdate, UserDelete, TeamDetail,
                    ...
                    CheckpointList, TeamList, base_map_view, delete_inivation, refuse_invitation, accept_invitation)
...
urlpatterns = [
    ...
    path("team/<str:pk>/<str:invited_user>/delete", delete_inivation, name="delete_invitation"),
    path("team/<str:pk>/refuse", refuse_invitation, name="refuse_invitation"),
    path("team/<str:pk>/accept", accept_invitation, name="accept_invitation"),
